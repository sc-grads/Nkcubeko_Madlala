...
font = Font(name='Tahoma', size=16, color=colors.BLUE, bold=True, italic=True, strike=False)
my_cell.font = font

## Setting a Pattern Fill
fill = PatternFill(fill_type='solid', fgColor=colors.BLACK)
my_cell.fill = fill

## Setting cell border
double_border_green = Side(border_style='double', color=colors.BLUE)
